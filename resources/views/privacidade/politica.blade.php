...
<body>
    ...
    <p>A sua privacidade é importante para nós. É política do Washington TCC respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href=http://frotauberaba.dev.br />Washington TCC</a>, e outros sites que possuímos e operamos.</p>
    <p>Solicitamos informações pessoais apenas quando realmente precisamos delas para lhe fornecer um serviço. Fazemo-lo por meios justos e legais, com o seu conhecimento e consentimento. Esse site e para apresentação do meu TCC. </p>
    ...
    <h2>Política de Cookies Washington TCC</h2>
    ...
    <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Washington TCC oferece no site e com caráter enunciativo, mas não limitativo:</p>
    <ul>
        ...
        <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Washington TCC, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
    </ul>
